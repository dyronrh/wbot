...
class ultraChatBot():
    def __init__(self, json):
        ...
        self.watsappAPIUrl = 'https://graph.facebook.com/v17.0/108117798988400/'
        self.token = 'EAAIv3ylZCuOQBAOMqJP5uui3FnOZBSjBvFcxubJaxvUbfZBxSnmZBUZCttrLU7qGTPEUQCTtWVAMnuDHRdySrTgGCvwrvOkwKvmyoOBXAPafBe2Y8talZALTOqcDWUbiAf1Ga696ATeKYrC5uj4BQx1FFpeSwoFY8CerAtEjmeSya5ADqCwO93quyv2CaKvLvX1TlKBX8OGwZDZD'

    def send_requests(self, type, data):
        url = f"{self.watsappAPIUrl}{type}?token={self.token}"
    ...
    def send_message(self, chatID, text):
        data = {"to": chatID,
                "body": text}
        answer = self.send_requests('messages', data)
        return answer
